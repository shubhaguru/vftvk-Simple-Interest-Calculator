function compute()
{
    ...
    document.getElementById("result").innerHTML="If you deposit \<mark>"+p+"\<mark\>,\<br\>at an interest rate of "+ri+"%\<br\>You will receive an amount of "+interest+",\<br\>in the year "+year+"\<br\>"
}
